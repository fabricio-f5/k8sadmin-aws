locals {
  # Região AWS onde todos os recursos serão criados
  aws_region = "us-east-1"

  # Nome do projeto — usado como prefixo nas tags de todos os recursos
...
remote_state {
  ...
  config = {
    ...
    # Deve existir antes de rodar o terragrunt apply
    # Crie manualmente: aws s3 mb s3://<NOME_DO_BUCKET> --region <REGIAO>
